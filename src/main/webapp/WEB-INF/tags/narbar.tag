...
<div class="col-sm-8">
	<div class="dropdown col-sm-9 padding-zero">
		<button class="btn-dropdown-page" style="float: left;"
			OnClick=" location.href='/'">Trang chủ</button>
		...
		<sec:authorize access="hasAuthority('TRACKING_CAR')">
			<div class="dropdown col-sm-2 padding-zero">
				<button class="btn-dropdown-page" onclick="location.href='/tracking-cars'">
				Theo dõi
				</button>
			</div>
		</sec:authorize>
...
<div class="col-sm-4">
	<div class="info-user">
		<button class="btn-dropdown">
			<span class="info"><img
				src="static/img/user/<sec:authentication property="principal.username" />.jpg"
				height="27px" width="23px" /></span> <span class="info"><sec:authentication
					property="principal.username" /></span> <span class="caret info"></span>
		</button>
		<div class="dropdown-content">
			<a href="/edit-profile">Thay đổi thông tin</a> <a
				href="/change-your-password">Đổi mật khẩu</a> <a
				href="/j_spring_security_logout">Đăng Xuất</a>
		</div>
	</div>
</div>